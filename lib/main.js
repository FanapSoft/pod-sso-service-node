...
class PodSSOService extends PodBaseService {
  ...
  constructor (confObj) {
    ...
    if (!validateResult.status) {
      throw utils.invalidConfigParam('pod-sso-service');
    }
    super(schemas, apiUrls, null);
    this.clientInfo = {};
  ...
  */
  ...
  handshake (data) {
    ...
    return this.callService(apiName, headers, data, false, data.client_id);
  }
  ...
  authorize (data) {
    ...
    return this.callService(apiName, headers, data, false, data.identity);
  }
